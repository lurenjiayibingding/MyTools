...
namespace ToolStorage.Definition.iTextPDFExtend
{
    ...
    /// </summary>
    public class TextVerbatimOverWritingListener : IEventListener
    {
        /// <summary>
        /// 需要被重写的文本
        /// </summary>
        ...
        public TextVerbatimOverWritingListener(string searchText, string substituteText, PdfPage pdfPage, PdfFont pdfFont)
        {
